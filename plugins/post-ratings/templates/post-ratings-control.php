...
<div class="ratings <?php if(is_singular()) print 'hreview-aggregate'; ?>" data-post="<?php the_ID(); ?>">
  ...
  <div class="meta">
     <?php
       ...
       printf(_n('%2$s average shaka rating', '%2$s average shaka rating', $votes, 'post-ratings'),
       sprintf('%d', $votes), sprintf('%.2F', $rating), sprintf('<strong>%d</strong>', $bayesian_rating));
     ?>
  </div>
