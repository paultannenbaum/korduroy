...
<div id="order_review">
	...
	<table class="shop_table">
        ...
        <tfoot>
			...
			<tr class="review-discount">
				<td><?php _e( 'Cart Discount', 'woocommerce' ); ?></td>
			...
			<?php foreach ( $woocommerce->cart->get_fees() as $fee ) : ?>
				...
				<tr class="review-fee fee-<?php echo $fee->id ?>">
			...
			<tr class="review-discount">
				<td><?php _e( 'Order Discount', 'woocommerce' ); ?></td>
