  ...
  <section class="footer-row">
    <div class="sponsors-container">
      <ul class="sponsors-list">
        <li class="sponsor-list-item huckberry"><a href="https://www.idevaffiliate.com/31555/idevaffiliate.php?id=395&url=7785" target="_blank"><img src="<?php echo bloginfo( 'template_directory' )?>/assets/images/sponsors/hb-logo.png"></a></li>
