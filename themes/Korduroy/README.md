...
- Concatenate and minify all plugins in `assets/js/vender` and `assets/js/source/log.js` to `assets/js/plugins.min.js`
...
* tweak Gruntfile.js to fix LiveReload issues and generate source maps for both main.js and log.js
...
* functions.php points to minified versions of log.js and jquery.functions.js
